...
set_interface_property dma associatedReset reset_sink
...
set_interface_property dma maximumPendingReadTransactions 1
...
add_interface_port dma dma_readdata readdata Output 32
...
add_interface_port dma dma_writedata writedata Input 32
add_interface_port dma dma_byteenable byteenable Input 4
set_interface_assignment dma embeddedsw.configuration.isFlash 0
set_interface_assignment dma embeddedsw.configuration.isMemoryDevice 0
set_interface_assignment dma embeddedsw.configuration.isNonVolatileStorage 0
set_interface_assignment dma embeddedsw.configuration.isPrintableDevice 0
