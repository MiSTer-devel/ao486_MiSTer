...
add_interface_port conduit_dma_floppy dma_floppy_req dma_floppy_req Output 1
add_interface_port conduit_dma_floppy dma_floppy_ack dma_floppy_ack Input 1
add_interface_port conduit_dma_floppy dma_floppy_terminal dma_floppy_terminal Input 1
add_interface_port conduit_dma_floppy dma_floppy_readdata dma_floppy_readdata Input 8
add_interface_port conduit_dma_floppy dma_floppy_writedata dma_floppy_writedata Output 8
...
add_interface_port req request request Output 2
add_interface_port req clock_rate clock_rate Input 28
