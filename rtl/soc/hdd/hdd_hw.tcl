...
add_interface_port req request request Output 3
add_interface_port req sec_read sec_read Input 1
add_interface_port req sec_write sec_write Input 1
add_interface_port req sec_writedata sec_writedata Input 32
add_interface_port req sec_readdata sec_readdata Output 32
