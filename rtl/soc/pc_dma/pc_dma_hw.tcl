...
add_interface_port dma avm_address address Output 24
add_interface_port dma avm_waitrequest waitrequest Input 1
add_interface_port dma avm_read read Output 1
add_interface_port dma avm_readdatavalid readdatavalid Input 1
add_interface_port dma avm_readdata readdata Input 8
add_interface_port dma avm_write write Output 1
add_interface_port dma avm_writedata writedata Output 8
