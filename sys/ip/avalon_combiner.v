...
(
	...
	output wire        mixer_read,           //           .read
	input  wire [31:0] mixer_readdata,       //           .readdata
	input  wire        mixer_readdatavalid,  //           .readdatavalid
	...
	output wire        scaler_read,          //           .read
	input  wire [31:0] scaler_readdata,      //           .readdata
	input  wire        scaler_readdatavalid, //           .readdatavalid
	...
	output wire        video_read,           //           .read
	input  wire [31:0] video_readdata,       //           .readdata
	input  wire        video_readdatavalid,  //           .readdatavalid
