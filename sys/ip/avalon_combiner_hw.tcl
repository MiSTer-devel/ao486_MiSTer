...
# Thu Apr 05 07:26:14 CST 2018
# DO NOT MODIFY


# 
# avalon_combiner "avalon_combiner" v17.0
# sorgelig 2018.04.05.07:26:14
# 
# 
...
set_interface_property ctl_mixer maximumPendingReadTransactions 2
set_interface_property ctl_mixer maximumPendingWriteTransactions 0
set_interface_property ctl_mixer readLatency 0
set_interface_property ctl_mixer readWaitTime 0
...
add_interface_port ctl_mixer mixer_readdata readdata Input 32
add_interface_port ctl_mixer mixer_read read Output 1
add_interface_port ctl_mixer mixer_readdatavalid readdatavalid Input 1
...
set_interface_property ctl_scaler maximumPendingReadTransactions 2
set_interface_property ctl_scaler maximumPendingWriteTransactions 0
set_interface_property ctl_scaler readLatency 0
set_interface_property ctl_scaler readWaitTime 0
...
add_interface_port ctl_scaler scaler_read read Output 1
add_interface_port ctl_scaler scaler_readdata readdata Input 32
add_interface_port ctl_scaler scaler_readdatavalid readdatavalid Input 1
...
set_interface_property ctl_video maximumPendingReadTransactions 2
set_interface_property ctl_video maximumPendingWriteTransactions 0
set_interface_property ctl_video readLatency 0
set_interface_property ctl_video readWaitTime 0
...
add_interface_port ctl_video video_read read Output 1
add_interface_port ctl_video video_readdata readdata Input 32
add_interface_port ctl_video video_readdatavalid readdatavalid Input 1
